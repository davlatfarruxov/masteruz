...
import profilePic from '../../img/image-11.jpg'
          ...
          <div className="container">
            <div className="home-portfolio">
              ...
              <div className="buttons">
                <button onClick={() => Router.push('/portfolio-pages/page-10')} className="button-1">Oldingi</button>
                <button onClick={() => Router.push('/portfolio')} className="button-2">Orqaga</button>
                <button onClick={() => Router.push('/portfolio-pages/page-12')} className="button-3">Keyingi</button>
              </div>
            </div>     
          </div>
      </header>
